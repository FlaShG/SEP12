...
public class RaumBauer
{
	...
	private RaumSammlungParser _sammlungParser;
	...
	private void initialisiereRaeumeHart()
	{
		...
		// 
		Raum gang = new Raum("Gang","Dr. Little stolpert in einen dunklen Gang. Die Wände sind mit Büsten von bekannten Unigrößen geschmückt.");
		// Kuuchen?
		Raum mensa = new Raum("Mensa","Dr. Little findet sich in der Mensa wieder. Die Stühle stehen nach dem letzten Mittagessen immer noch im Raum herum.");
		//
		Raum herrentiolette = new Raum("Herrentoilette","Dr. Little betritt die Herrentoilette. Er würde sich gerne die Hände waschen, das Waschbecken ist allerdings viel zu weit oben angebracht.");
		// 
		Raum westfluegel = new Raum("Westflügel","Dr. Little schlendert durch den einsturzgefährdeten Westflügel, dessen morsche Dachbalken wie ein Damoklesschwert über ihm ächtzen.");
		//
		Raum terasse = new Raum("Terrasse",
		...
		//
		Raum flurchemie = new Raum("Flur Chemie","Dr. Little betritt den Chemieflur. Während er duch den Gang wandert, erschüttert eine Explosion in einem Nebenraum das Gebäude.");
		//
		Raum eingangchemie = new Raum("Eingang Chemie","Dr. Little betritt das Chemiegebäude. Eine Ansammlung von kitteltragenden Wissenschaftlern begräbt ihn fast unter ihren Füßen.");
		//
		Raum flur = new Raum("Flur","Dr. Little betritt einen Flur.");
		//
		Raum burerohausmeister = new Raum("Hausmeisterbüro",
		...
		// 
		Raum besenkammerhausmeister = new Raum("Besenkammer",
		...
		//
		Raum bibliothek = new Raum("Bibliothek","Dr. Little betritt die Bibliothek. Ein Haufen Bücher und eine ermahnende Bibliothekarin sind angesichts seiner geringen Größe ein beeindruckender Anblick.");
		//
		Raum wohnung = new Raum("Wohnung",
		...
		//
		Raum konferenzraum = new Raum("Konferenzraum","Dr. Little betritt einen Konferenzraum. Einige Geschäftsleute sind gerade dabei ihre Taschen zu packen. Die nächsten stehen bereits vor der Tür.");
		// Even Bigger Labor Ende
		Raum buerovondoktorevenbigger = new Raum("Büro",
		...
		List<Raum> sammlung = _sammlungParser.getSammlung();
		sammlung.add(labor);
		sammlung.add(gang);
		sammlung.add(mensa);
