...
public class Server extends UnicastRemoteObject implements ServerInterface
{
	...
	//sinnlos?
	public boolean sendeAenderungen(List<ClientPaket> paketListe) throws RemoteException
	{
		boolean result = true;
		
		for (ClientPaket paket : paketListe)
		{
			ClientInterface client = _connectedClients.get(paket.getSpielerName());
	...
	@Override
	public boolean loginClient(ClientInterface client, String name) throws RemoteException
	{
		boolean result;
		
		if (_connectedClients.containsKey(name) || _connectedClients.containsValue(client))
		{
			result = false;
		}
		else
