...
public class XmlRaum
{
	...
	private @XmlElement(name = "nordid") int _nordID;
	private @XmlElement(name = "ostid") int _ostID;
	private @XmlElement(name = "suedid") int _suedID;
	private @XmlElement(name = "westid") int _westID;
