...
\begin{frame}
  ...
  \begin{itemize}
     \item Definition: Versionskontrollsystem (VCS) \\
           Ein Werkzeug, dass das Kontrollieren unterschiedlicher Versionen eines Projektes ermöglicht und vereinfacht.
  \end{itemize}
\end{frame} 
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Vereinfachtes Zusammenführen mehrer Code-Versionen
...
\begin{frame}
  \frametitle{Weitere Informationen zu Git}
  \begin{itemize}
    \item Kurz-Info: http://ep.mafiasi.de/SEP12
    \item Git und eGit Cheat Sheet auf unserer Git-Repo
    \item http://git-scm.com/docs
  \end{itemize}
\end{frame}
