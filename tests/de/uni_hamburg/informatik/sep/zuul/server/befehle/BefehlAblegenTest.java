...
public class BefehlAblegenTest
{
	...
	/**
	 * Test method for
	 * {@link de.uni_hamburg.informatik.sep.zuul.server.befehle.BefehlAblegen#ausfuehren(de.uni_hamburg.informatik.sep.zuul.server.util.ServerKontext, de.uni_hamburg.informatik.sep.zuul.server.spiel.Spieler, de.uni_hamburg.informatik.sep.zuul.server.befehle.Befehlszeile)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.uni_hamburg.informatik.sep.zuul.server.befehle.BefehlAblegen#getBefehlsnamen()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.uni_hamburg.informatik.sep.zuul.server.befehle.BefehlAblegen#vorbedingungErfuellt(de.uni_hamburg.informatik.sep.zuul.server.util.ServerKontext, de.uni_hamburg.informatik.sep.zuul.server.spiel.Spieler, de.uni_hamburg.informatik.sep.zuul.server.befehle.Befehlszeile)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.uni_hamburg.informatik.sep.zuul.server.befehle.BefehlAblegen#gibFehlerAus(de.uni_hamburg.informatik.sep.zuul.server.util.ServerKontext, de.uni_hamburg.informatik.sep.zuul.server.spiel.Spieler, de.uni_hamburg.informatik.sep.zuul.server.befehle.Befehlszeile)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.uni_hamburg.informatik.sep.zuul.server.befehle.BefehlAblegen#getHilfe()}
	 * .
	 */
	@Test
