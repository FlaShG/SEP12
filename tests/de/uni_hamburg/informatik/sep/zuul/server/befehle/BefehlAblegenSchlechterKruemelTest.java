...
public class BefehlAblegenSchlechterKruemelTest
{
	BefehlAblegenSchlechterKruemel ablegen = new BefehlAblegenSchlechterKruemel();
    ...
    Befehlszeile befehlszeile= new Befehlszeile("ablegen schlechter krümel");
	...
	public void testAusfuehren()
	{
		...
		assertEquals(Item.UGiftkuchen, raum.getNaechstesItem());
	...
	{
		assertEquals( "ablegen schlechter krümel", ablegen.getBefehlsnamen()[0]);
	}

	@Test
	public void testVorbedingungErfuellt()
	{
		Spieler spieler3 = new Spieler("nurUgiftkuchen");
	    Inventar inventar3 = new Inventar();
	    inventar3.fuegeItemHinzu(Item.UGiftkuchen);
		...
		assertFalse(ablegen.vorbedingungErfuellt(kontext, spieler3, befehlszeile));
	}
