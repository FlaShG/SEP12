...
public class ServerKontextTest
{
	...
	public void testGetSpielerNamenInRaum()
	{
		...
		assertTrue(_kontext.getSpielerNamenInRaum(_startRaum).contains(
				_spieler1.getName()));
		assertTrue(_kontext.getSpielerNamenInRaum(_startRaum).contains(
				_spieler2.getName()));
		assertTrue(_kontext.getSpielerNamenInRaum(_startRaum).contains(
		...
		assertTrue(_kontext.getSpielerNamenInRaum(_startRaum).contains(
				_spieler3.getName()));
		assertTrue(_kontext.getSpielerNamenInRaum(_naechsterRaum).contains(
				_spieler2.getName()));
	...
	public void testSchreibeAnSpieler()
	{
		...
		_kontext.schreibeAnSpieler(_spieler2, "noch ne nachricht");
		_kontext.schreibeAnSpieler(_spieler3,
				"den gibts nicht und es gibt auch keine nachricht");
	...
	public void testGetRaeumeInDemSichSpielerAufhalten()
	{
		...
		assertTrue(_kontext.getRaeumeInDemSichSpielerAufhalten().contains(
				_startRaum));
